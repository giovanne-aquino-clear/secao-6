...
class DropBoxController{
        ...
        constructor() {
            ...
            this.progressBarEl = this.snackModelEl  .querySelector('.mc-progress-bar-fg') // chama o meio css de vizualisação da barra de upload
            this.namefileEl = this.snackModelEl .querySelector('.filename');// chama o meio css para exibir o nome do arquivo
            this.timeleftEl = this.snackModelEl .querySelector('.timeleft');// chama o meio css para exibir o tempo de progresso da barra
        ...
        //carrega as informaçoes do firebase 
        connectFirebase(){

            var cofing = {
                apiKey: "AIzaSyDVbVeIiMoBkQTeUvN0Nm6fLK4s7Ac67qs",
                authDomain: "drop-box-clone-652ef.firebaseapp.com",
                databaseURL: "https://drop-box-clone-652ef-default-rtdb.firebaseio.com",
                projectId: "drop-box-clone-652ef",
                    storageBucket: "drop-box-clone-652ef.appspot.com",
                messagingSenderId: "41229151997",
                appId: "1:41229151997:web:2d19e64683ed08e5959894",
                measurementId: "G-NFVW09JMRW"
              };
        ...
        initEvents(){
          ...
          this.btnNewFolder.addEventListener('click', e=>{
            ...
            // usa para obter a seleção de arquivos através do botão "enviar arquivos"
            this.btnSendFileEl.addEventListener('click', event => {
                this.inputFilesEl.click(); 
            });
            // quando envia o arquivo alterando o estado inicial envia para a tela a snackbar do carregamento do arquivo
            ...
            return new Promise((resolve,reject)=>{
              ...
              let ajax = new XMLHttpRequest();
                    ...
                    ajax.onload = event => {
                        ...
                        try{
                            resolve(JSON.parse(ajax.responseText)); // passa o arquivo para JSON caso não consiga informa erro
                        } catch (e) {
        ...
        uploadProgress(event,file){// mostra progresso do upload 
            ...
            let loaded = event.loaded;// pega o progresso atual
            let total = event.total;// pega o total
            let porcent = parseInt((loaded / total)*100);// divide ambos e passa para numero inteiro 
            let timeleft = ((100 - porcent)* timespent) / porcent;// calcula o tempo que ja passou para chegar no tempo estimado que falta 

            this.progressBarEl.style.width = `${porcent}%`;// aumenta a barra de progresso de acordo com a porcentagem 
            
            this.namefileEl.innerHTML = file.name;// carrega o nome do arquivo 
            this.timeleftEl.innerHTML = this.formatTimeToHuman(timeleft)// converte o tempo para horas ,minutos e segundos

       
        }

        // faz o calculo e converte a data 
        formatTimeToHuman(duration){
            ...
            if(hours > 0 ){
                return `${hours}${minutes} minutos e ${seconds} segundos`;
            }
            if (minutes > 0){
    ...
    // pega o icon de cada tipo de arquivo, pegando o codigo html/css de cada um, usando um switch case
